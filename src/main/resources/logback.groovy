...
def logDir = new File(System.getProperty("user.home"), "/logs/thnolg").toString();
def logName = "fakeplayer.log";
...
logger("org.thehellnet.thnolg.fakeplayer.socket", INFO)
logger("org.thehellnet.thnolg.fakeplayer", DEBUG)
